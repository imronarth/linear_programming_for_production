...
public class Produk_Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        KodeProduktxt.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                KodeProduktxtKeyTyped(evt);
            }
        });

        NamaProduktxt.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                NamaProduktxtKeyTyped(evt);
            }
        });
    ...
    private void NamaProduktxtKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NamaProduktxtKeyTyped
        // SORTING ROW BERDASARKAN NAMA PRODUK
        DefaultTableModel model=(DefaultTableModel) jTable1.getModel();
        try{
            String text = NamaProduktxt.getText();
    ...
    }//GEN-LAST:event_NamaProduktxtKeyTyped

    private void KodeProduktxtKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeProduktxtKeyTyped
        // SORTING ROW BERDASARKAN KODE PRODUK
        DefaultTableModel model =(DefaultTableModel) jTable1.getModel();
        try{
            String text2= KodeProduktxt.getText();
            TableRowSorter<TableModel> rowSorter = new TableRowSorter<>(model);
            jTable1.setRowSorter(rowSorter);
            if(text2.trim().length() == 0){
                ...
                rowSorter.setRowFilter(RowFilter.regexFilter(text2));
            }
        }catch(Exception e){
            e.printStackTrace();
        }
    }//GEN-LAST:event_KodeProduktxtKeyTyped
